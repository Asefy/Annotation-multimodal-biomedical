...
from cytomine.models import AnnotationCollection, ImageInstanceCollection,ImageInstance, ProjectCollection, AnnotationLinkCollection, Annotation
...
"""
def build_all(annot_group_coll, init_path_imgs="dl-file/526102245/reduced_img/", dataset_folder="tmp/", override=False):
